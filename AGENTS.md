...
To run the custom suite of unit test for Yonius use the following sequence of commands that will install dependencies
...
Yonius is licensed under the [Apache License, Version 2.0](http://www.apache.org/licenses/).
